...
Ce matin au démarrage des containers, le container de docker ne se lançait pas.
C'étais un problème de sécurité qui bloquait son lancement.
Pour régler cela, il fallait désactiver les sécurités docker ou les modifier pour le https
...
volumes:
 ...
 J'ai donc modifié la "max virtual memory" de mon docker desktop en faisant les commandes :
 `wsl -d docker-desktop`
 `sysctl -w vm.max_map_count=262144`
 De cette façon, docker peut alouer plus de mémoire.
